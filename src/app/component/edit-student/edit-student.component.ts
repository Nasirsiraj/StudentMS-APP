        ...
        .subscribe(
          (response) => {
            ...
            if(this.student == null){
              this.snackBar.open('No student found', 'Close', {duration: 5000})
        ...
        .subscribe(
          (response) => {
            if(response == null){
              ...
              this.snackBar.open('Saving failed!', 'Close', {duration: 5000})

            }else if(response != null && response.id != value.id){
              this.isSucceed = false
              this.snackBar.open('Error Occurred!', 'Close', {duration: 5000})
